...
size_t HashFunction::RollingHash(const std::string& key) const
{
    size_t hash = 0;
...
size_t HashFunction::CityHash(const std::string& key) const
{
    size_t hash = 0;
...
size_t HashFunction::FNV1a(const std::string& key) const
{
...
size_t HashFunction::MurmurHash(const std::string& key) const
{
